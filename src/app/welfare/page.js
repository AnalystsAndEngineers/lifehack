...
export default function Welfare() {
  return (
    <div>
      <label
        for="message"
        class="px-7 flex justify-center mt-10 text-center mb-2 text-sm font-medium text-gray-900 dark:text-white"
      >
      ...
      <textarea
        id="message"
        rows="4"
        class="block p-2.5 w-10/12 lg:w-8/12 mx-auto text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
