      ...
      <html lang="en">
        <body className={montserrat.className}>
          {sessionId ? (
            ...
            <main className={`flex h-screen items-center justify-center bg-cover bg-image ${styles.bgImage} ${styles.blurBg}`}>
              <div className="p-4 text-center bg-white rounded-xl p-10">
